...
# 1. players should always stick together as much as possible. I added a teleport resource where players can teleport to a  waypoint set neat other player (wihtin 300m) using right stick down and dpad up simultaenously (or keyboard equivalents) Control Indexes 26 & 27. https://docs.fivem.net/docs/game-references/controls/ Mission resource drops for fast travel can be used too.
